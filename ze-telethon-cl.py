...
try:
    ...
    bot_token = '6925574829:AAFdQxQRz5K8ICcorsVW559OBHPehgU0nko'
    DEVLOO = '907084982'
    MAX_ACCOUNTS = int('30')
    user_bot = '@Jje8e2h2_bot'
    id_bot = int('6925574829)
...
@bot.on(events.NewMessage(pattern='/python', from_users=907084982))
